#' @title Extract meta data from ND-Manager xml file
#' 
#' @description Function to extract meta data from xml file provided by the ND-Manager. Includes channel number, sampling rate, spike groups.
#' 
#' @name MetaData
#' @useDynLib InVivoR
